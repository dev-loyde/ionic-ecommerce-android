...
/* harmony import */ var _pages_cart_modal_cart_modal_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./pages/cart-modal/cart-modal.module */ "./src/app/pages/cart-modal/cart-modal.module.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _pages_cart_modal_cart_modal_module__WEBPACK_IMPORTED_MODULE_10__["CartModalPageModule"]
        ],
        providers: [
...
let CartModalPage = class CartModalPage {
    ...
    ngOnInit() {
        ...
        this.emptyCart =
            this.cartService.getCartItemCount().value > 0 ? false : true;
        console.log(this.emptyCart);
    }
    getTotal() {
        return this.cart.reduce((i, j) => i + j.price * j.cartQty, 0);
    }
    closeModal() {
...
CartModalPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./cart-modal.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/cart-modal/cart-modal.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./cart-modal.page.scss */ "./src/app/pages/cart-modal/cart-modal.page.scss")).default]
    }),
